...
class Tracking:
    ...
    def log_histogram(self, data, step):
        assert "tensorboard" in self.logger, "Tensorboard logger is not initialized, histogram only supports tensorboard backend now"
        self.logger["tensorboard"].log_histogram(data=data, step=step)
...
class _TensorboardAdapter:
    def __init__(self):
        ...
        print(f"[TensorboardAdapter] Saving tensorboard log to {tensorboard_dir}.")
        self.writer = SummaryWriter(tensorboard_dir)

    def log(self, data, step):
        # print(f"[TensorboardAdapter] Logging data at step {step}: {data}")
        for key in data:
    ...
    def finish(self):
        # print("[TensorboardAdapter] Closing writer.")
        self.writer.close()
